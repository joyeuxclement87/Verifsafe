...
import { FileText, Bulb, Shield, Building, CircleCheck } from 'tabler-icons-react';
  ...
  const types = [
    {
      ...
      description: 'Energy-efficient lighting systems with backup power'
    },
    {
      name: 'Exit signage systems',
      description: 'High-visibility exit signs for clear evacuation guidance'
    }
  ];
      ...
      <section className="w-full py-20 bg-linear-to-r from-[#FF4D4D] to-[#E53935] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Protect your occupants with emergency lighting and exit signs.
          </p>
      ...
      <section className="w-full py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Fire Detection Devices</h3>
                <p className="text-gray-600 text-center">Early detection systems for fire prevention</p>
              </div>
            </Link>
