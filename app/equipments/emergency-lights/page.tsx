            ...
            <div className="relative">
              <div className="aspect-square bg-gray-50 rounded-3xl overflow-hidden shadow-2xl relative border border-gray-100">
                 ...
                 <div className="flex items-center justify-center h-full">
                    <DoorExit size={200} strokeWidth={0.5} className="text-gray-200" />
                 </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="flex flex-col gap-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 leading-tight" style={{ fontFamily: 'Oswald, sans-serif' }}>
                Need <span className="text-[#E53935]">Emergency Lights</span>?
              </h2>
              <p className="text-base sm:text-lg text-gray-600 font-normal leading-relaxed" style={{ fontFamily: 'Noto Sans, sans-serif', fontWeight: 400 }}>
                From small shops to large industrial sites, we provide comprehensive emergency lighting solutions.
              </p>
            ...
            <div>
              <form onSubmit={(e) => { e.preventDefault(); }} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-800 mb-2" style={{ fontFamily: 'Noto Sans, sans-serif' }}>Light Type Interest</label>
                  <select className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:border-[#E53935] outline-none transition-all text-gray-900" style={{ fontFamily: 'Noto Sans, sans-serif', borderWidth: '1px' }} defaultValue="Non-Maintained">
                    <option value="Non-Maintained">Non-Maintained Lights</option>
                    <option value="Maintained">Maintained Lights</option>
                    <option value="ExitSigns">Exit Signage</option>
                    <option value="Maintenance">Mandatory Testing</option>
                  </select>
                </div>
                <div>
