...
import { FileText, Bell, Shield, Settings, Building, CircleCheck } from 'tabler-icons-react';
  ...
  const systemTypes = [
    {
      ...
      description: 'Cost-effective systems suitable for smaller buildings'
    },
    {
      name: 'Addressable Systems',
      description: 'Advanced systems with precise location identification'
    },
    {
      name: 'Wireless Alarm Systems',
      description: 'Modern systems without extensive wiring requirements'
    }
  ];
          ...
          <div className="flex items-start gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Fire alarm systems detect smoke, heat, or fire and alert occupants through sound or visual signals, allowing quick evacuation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-start gap-8 mb-12">
            <div className="shrink-0">
              <div className="flex items-center justify-center h-16 w-16 rounded-lg bg-[#E53935]/10">
                <Settings size={32} className="text-[#E53935]" strokeWidth={1.5} />
              </div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {components.map((component, index) => (
              <div key={index} className="bg-white rounded-lg p-4 border-l-4 border-[#E53935] shadow-md">
                <p className="text-gray-900 font-semibold text-center">{component}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full py-20 bg-linear-to-r from-[#FF4D4D] to-[#E53935] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Request Fire Alarm System Installation today.
          </p>
