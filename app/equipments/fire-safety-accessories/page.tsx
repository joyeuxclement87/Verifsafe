            ...
            <div className="relative">
              <div className="aspect-square bg-gray-50 rounded-3xl overflow-hidden shadow-2xl relative border border-gray-100">
                 ...
                 <div className="flex items-center justify-center h-full">
                    <Package size={200} strokeWidth={0.5} className="text-gray-200" />
                 </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="flex flex-col gap-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 leading-tight" style={{ fontFamily: 'Oswald, sans-serif' }}>
                Need <span className="text-[#E53935]">Accessories</span>?
              </h2>
              <p className="text-base sm:text-lg text-gray-600 font-normal leading-relaxed" style={{ fontFamily: 'Noto Sans, sans-serif', fontWeight: 400 }}>
                From heavy-duty cabinets to photoluminescent signs, we supply everything needed for a compliant safety setup.
              </p>
            ...
            <div>
              <form onSubmit={(e) => { e.preventDefault(); }} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-800 mb-2" style={{ fontFamily: 'Noto Sans, sans-serif' }}>Accessory Interest</label>
                  <select className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:border-[#E53935] outline-none transition-all text-gray-900" style={{ fontFamily: 'Noto Sans, sans-serif', borderWidth: '1px' }} defaultValue="Cabinets">
                    <option value="Cabinets">Cabinets & Stands</option>
                    <option value="Blankets">Fire Blankets</option>
                    <option value="Signage">Safety Signage</option>
                    <option value="Bulk">Bulk Site Supply</option>
                  </select>
                </div>
                <div>
