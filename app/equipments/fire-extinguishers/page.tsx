    ...
    <main className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <p className="text-3xl font-black text-[#E53935]" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>6KG</p>
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 bg-linear-to-b from-gray-50 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-3 leading-tight" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Choose the <span className="text-[#E53935]">Right Type</span></h2>
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 group-hover:text-[#E53935] transition-colors" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{type.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 xl:gap-20 relative z-10 items-start">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl xl:text-5xl font-black text-gray-900 mb-5 leading-tight uppercase" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Fire <span className="text-[#E53935]">Classes</span></h2>
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                {[
                  ...
                  >
                    <div className="w-14 h-14 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-[#E53935]/10 group-hover:text-[#E53935] transition-all duration-500 shrink-0"><span className="text-2xl font-black" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{item.class}</span></div>
                    <div className="flex flex-col"><span className="text-xl font-bold text-gray-900 group-hover:text-[#E53935] transition-colors duration-300" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{item.title}</span><span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors duration-300">{item.detail}</span></div>
                  </motion.div>
                ))}
              </div>
            </div>
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 bg-linear-to-b from-gray-50 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-5 leading-tight uppercase" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Available <span className="text-[#E53935]">Sizes</span></h2>
            <div className="w-20 h-1 bg-[#E53935] rounded-full mx-auto mb-6" />
            ...
            {sizes.map((sizeCategory, index) => (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div><h3 className="text-xl font-bold text-gray-900 group-hover:text-[#E53935] transition-colors" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{sizeCategory.category}</h3><p className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">{sizeCategory.description}</p></div>
                </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 xl:gap-20 relative z-10 items-start">
              <div className="lg:col-span-1 lg:sticky lg:top-8">
                ...
                <h2 className="text-3xl sm:text-4xl xl:text-5xl font-black text-gray-900 mb-5 leading-tight uppercase" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Simple <span className="text-[#E53935]">Buyer&apos;s Guide</span></h2>
                <div className="w-20 h-1 bg-[#E53935] rounded-full mb-6" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                  {buyerGuide.map((guide, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col"><h3 className="text-xl font-bold text-gray-900 group-hover:text-[#E53935] transition-colors truncate" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{guide.scenario}</h3><p className="text-sm font-black text-[#E53935] uppercase tracking-wider mt-1">Use: {guide.recommendation}</p></div>
                    </motion.div>
                  ))}
                </div>
              </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 xl:gap-20 relative z-10 items-start">
              <div className="lg:col-span-1 lg:sticky lg:top-8">
                ...
                <h2 className="text-3xl sm:text-4xl xl:text-5xl font-black text-gray-900 mb-5 leading-tight uppercase" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Ideal <span className="text-[#E53935]">Applications</span></h2>
                <div className="w-20 h-1 bg-[#E53935] rounded-full mb-6" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                  {applications.slice(0, 4).map((app, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col"><span className="text-xl font-bold text-gray-900 group-hover:text-[#E53935] transition-colors duration-300" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>{app}</span><span className="text-sm text-gray-400">Essential Safety Protection</span></div>
                    </motion.div>
                  ))}
                </div>
              </div>
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="text-center mb-10"
          >
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-3 leading-tight" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Features & <span className="text-[#E53935]">Benefits</span></h2>
      ...
      <section className="relative w-full py-14 sm:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-4 leading-tight" style={{ fontFamily: "'Oakes Grotesk', sans-serif" }}>Ensure your <span className="text-[#E53935]">safety today</span></h2>
