...
import { getStatusCounts, getEnquiries } from '@/lib/enquiries'
import { getGalleryItems } from '@/lib/gallery'
import { formatShortDate } from '@/lib/format'
import { StatusBadge, PublishBadge } from '@/components/ui/Badge'
    ...
    <div className="space-y-10">
      ...
      <section aria-label="Enquiry overview">
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <StatCard label="All enquiries" value={total} href="/enquiries" />
          <StatCard label="New enquiries" value={counts.new} href="/enquiries?status=new" />
          <StatCard
            label="In progress"
            value={counts.in_progress}
            href="/enquiries?status=in_progress"
          />
          <StatCard label="Completed" value={counts.completed} href="/enquiries?status=completed" />
        </div>
      </section>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* Recent enquiries */}
        <section>
          <SectionHeader title="Recent enquiries" href="/enquiries" linkLabel="View all" />
        ...
        {/* Recent gallery */}
        <section>
          <SectionHeader title="Recent gallery uploads" href="/gallery" linkLabel="Manage gallery" />
